...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mountaincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mountaincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mountaincoin transaction") + "\n" +
              "  mountaincoin-tx [options] -create [commands]   " + _("Create hex-encoded mountaincoin transaction") + "\n" +
              "\n";

...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mountaincoin-project/mountaincoin>";
    const std::string URL_WEBSITE = "<https://mountaincoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Mountaincoin version %s\n", FormatFullVersion());
}
